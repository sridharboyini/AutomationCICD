...
WebUI.callTestCase(findTestCase('Party Test Cases/Add Test Cases/Add New Party'), [('RoleString') : 'Dispenser', ('PartyType') : 'Partner'
...
WebUI.callTestCase(findTestCase('SN Template Test cases/Add new Template with Active status'), [('TemplateName') : '', ('ProductOwner') : GlobalVariable.PARTY_NAME
...
WebUI.callTestCase(findTestCase('SGTIN Profile Test Cases/Add New SGTIN Profile'), [('ProductCode') : GlobalVariable.ID_GTIN, ('SerialNumberTemplate') : GlobalVariable.SN_TEMPLATE_NAME
