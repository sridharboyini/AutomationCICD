...
WebUI.verifyElementPresent(findTestObject('Party Record/Locations Tab/Location Record/Digital Address'), 10)
...
WebUI.setText(findTestObject('Party Record/Locations Tab/Location Record/Digital Address'), DigitalAddress)
