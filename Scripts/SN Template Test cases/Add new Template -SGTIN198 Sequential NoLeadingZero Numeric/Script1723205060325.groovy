...
WebUI.selectOptionByLabel(findTestObject('SN Template Record/Template Details/Allow Leading Zero'), 'No', false)
...
WebUI.waitForElementClickable(findTestObject('SN Template Record/Template Details/bt_SaveTemplate'), 10)
