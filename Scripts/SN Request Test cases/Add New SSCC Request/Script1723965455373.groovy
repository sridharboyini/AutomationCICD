...
WebUI.click(findTestObject('Serial Number Request Record/option_SSCC'))
...
WebUI.setText(findTestObject('Serial Number Request Record/SSCC Request/Request Quantity'), RequestQuantity)

WebUI.scrollToElement(findTestObject('Home/Bread Crumbs'), 10)

WebUI.click(findTestObject('Serial Number Request Record/bt_Submit SSCC'))
...
WebUI.verifyTextPresent(GS1Prefix, false)
