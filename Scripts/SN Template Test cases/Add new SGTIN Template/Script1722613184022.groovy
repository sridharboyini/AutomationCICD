...
WebUI.selectOptionByLabel(findTestObject('Serial Number Template Record/Template Details/EPC Schema'), EPCSchema, false)

WebUI.selectOptionByLabel(findTestObject('Serial Number Template Record/Template Details/Coding Schema'), CodingSchema, 
    false)
...
WebUI.click(findTestObject('Serial Number Template Record/Template Details/input_Numeric'))

WebUI.selectOptionByLabel(findTestObject('Serial Number Template Record/Template Details/Sparseness Factor'), SparsenessFactor, 
    false)

WebUI.selectOptionByLabel(findTestObject('Serial Number Template Record/Template Details/Uniqueness'), Uniqueness, false)
...
TemplateName = WebUI.getAttribute(findTestObject('Object Repository/Serial Number Template Record/Template Details/Serial Number Template Name'), 
    'Value')

GlobalVariable.SN_TEMPLATE_NAME = TemplateName

WebUI.click(findTestObject('Serial Number Template Record/Template Details/button_Assign Template Tab'))

WebUI.click(findTestObject('Serial Number Template Record/Assign Template Tab/Product Owner dropdown'))

WebUI.setText(findTestObject('Serial Number Template Record/Assign Template Tab/Product Owner search'), ProductOwner)

WebUI.click(findTestObject('Serial Number Template Record/Assign Template Tab/Product Owner checkbox_DO', [('ProductOwner') : ProductOwner]))

WebUI.click(findTestObject('Serial Number Template Record/Assign Template Tab/button_Add'))

WebUI.verifyElementPresent(findTestObject('Serial Number Template Record/Assign Template Tab/Product Owner row_DO', [('ProductOwner') : ProductOwner]), 
    10)

WebUI.scrollToElement(findTestObject('Home/Bread Crumbs'), 0)

WebUI.click(findTestObject('Serial Number Template Record/Template Details/button_Save'))
