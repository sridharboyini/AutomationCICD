...
WebUI.selectOptionByLabel(findTestObject('Party Record/Locations Tab/Location Record/Location Classification'), 'Location', 
    false)
...
WebUI.setText(findTestObject('Party Record/Locations Tab/Location Record/Alternate Name'), 'Alternate Name')

WebUI.setText(findTestObject('Party Record/Locations Tab/Location Record/Description'), 'Testing')
