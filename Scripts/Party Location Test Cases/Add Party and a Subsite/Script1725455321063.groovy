...
WebUI.selectOptionByLabel(findTestObject('Party Record/Locations Tab/Location Record/Location Classification'), LocationClassification, 
    false)

WebUI.verifyElementPresent(findTestObject('Party Record/Locations Tab/Location Record/Sub-Site Type'), 10)
...
WebUI.selectOptionByLabel(findTestObject('Party Record/Locations Tab/Location Record/Sub-Site Type'), SubSiteType, false)

WebUI.click(findTestObject('Party Record/Locations Tab/Location Record/Sub-Site Attributes'))

WebUI.setText(findTestObject('Party Record/Locations Tab/Location Record/Sub-Site Attributes_search'), SubSiteAttributes)

WebUI.click(findTestObject('Party Record/Locations Tab/Location Record/Sub-Site Attributes_searchResult'))

String parentName = WebUI.getText(findTestObject('Party Record/Locations Tab/Location Record/Location Parent Name'))

String SubsiteName = (LocationType + ' of ') + parentName

WebUI.setText(findTestObject('Party Record/Locations Tab/Location Record/Subsite Name'), SubsiteName)
